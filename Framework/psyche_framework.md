...
4. **Dynamic Focus Shifting:** The active Focus is not static. The AI must automatically shift the character's active Focus to whichever of the 10 Realms is most relevant to the immediate scene context, conflict, and emotional pressure (e.g., shifting to Realm IX under physical threat/edge conditions, or Realm II under craft/form pressure), unless the Focus is explicitly locked.
